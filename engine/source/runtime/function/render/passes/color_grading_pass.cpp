...
namespace Piccolo
{
    ...
    void ColorGradingPass::preparePassData(std::shared_ptr<RenderResourceBase> render_resource)
    {
        const RenderResource* vulkan_resource = static_cast<const RenderResource*>(render_resource.get());
        if (vulkan_resource)
        {
            m_color_grading_cosntant_object.color_grading_effect = vulkan_resource->m_render_global_effect_setting_object.useColorGrading;
            m_color_grading_cosntant_object.brightness = vulkan_resource->m_render_global_effect_setting_object.brightness;
            m_color_grading_cosntant_object.contrast = vulkan_resource->m_render_global_effect_setting_object.contrast;
            m_color_grading_cosntant_object.saturation = vulkan_resource->m_render_global_effect_setting_object.saturation;
            m_color_grading_cosntant_object.temperature = vulkan_resource->m_render_global_effect_setting_object.temperature;
        }
    }
    ...
    void ColorGradingPass::setupPipelines()
    {
        ...
        pushConstantRange.size       = sizeof(ColorGradingConstantObject);
        ...
        pipelineInfo.subpass             = _post_process_subpass_color_grading;
    ...
    void ColorGradingPass::draw()
    {
        ...
        vkCmdPushConstants(m_vulkan_rhi->m_current_post_process_command_buffer,
                           m_render_pipelines[0].layout,
                           VK_SHADER_STAGE_FRAGMENT_BIT,
                           0,
                           sizeof(ColorGradingConstantObject),
                           &m_color_grading_cosntant_object);
