...
namespace Piccolo
{
    ...
    void VignettePass::preparePassData(std::shared_ptr<RenderResourceBase> render_resource)
    {
        const RenderResource* vulkan_resource = static_cast<const RenderResource*>(render_resource.get());
        if (vulkan_resource)
        {
            m_vignette_push_constant_object.vignette_cutoff = vulkan_resource->m_render_global_effect_setting_object.vignetteCutoff;
            m_vignette_push_constant_object.vignette_exponent = vulkan_resource->m_render_global_effect_setting_object.vignetteExponent;
        }
    }
    ...
    void VignettePass::setupPipelines()
    {
        ...
        pushConstantRange.size       = sizeof(VignettePushConstantObject);
        ...
        pipelineInfo.subpass             = _post_process_subpass_vignette;
    ...
    void VignettePass::draw()
    {
        ...
        vkCmdPushConstants(m_vulkan_rhi->m_current_post_process_command_buffer,
                           ...
                           0,
                           sizeof(VignettePushConstantObject),
                           &m_vignette_push_constant_object);
