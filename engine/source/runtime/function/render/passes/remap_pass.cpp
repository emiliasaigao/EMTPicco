...
#include <remap_frag.h>

#include <stdexcept>

namespace Piccolo
{
    void RemapPass::initialize(const RenderPassInitInfo* init_info)
    {
        RenderPass::initialize(nullptr);

        const RemapPassInitInfo* _init_info = static_cast<const RemapPassInitInfo*>(init_info);
    ...
    void RemapPass::setupDescriptorSetLayout()
    {
    ...
    void RemapPass::setupPipelines()
    {
        ...
        VkShaderModule frag_shader_module = VulkanUtil::createShaderModule(m_vulkan_rhi->m_device, REMAP_FRAG);
        ...
        pipelineInfo.subpass             = _post_process_subpass_remap;
    ...
    void RemapPass::setupDescriptorSet()
    {
    ...
    void RemapPass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
    ...
    void RemapPass::draw()
    {
        if (m_vulkan_rhi->isDebugLabelEnabled())
        {
            VkDebugUtilsLabelEXT label_info = {
                VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT, NULL, "Remap", {1.0f, 1.0f, 1.0f, 1.0f}};
