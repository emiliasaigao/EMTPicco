...
namespace Piccolo
{
    struct MeshVertex
    {
        ...
        static std::array<VkVertexInputBindingDescription, 4> getBindingDescriptionsWithVertexColor()
        {
            ...
            binding_descriptions[3].stride    = sizeof(VulkanMeshVertexColor);
        ...
        static std::array<VkVertexInputAttributeDescription, 5> getAttributeDescriptionsWithVertexColor()
        {
            ...
            // vertex color
            attribute_descriptions[4].binding  = 3;
            attribute_descriptions[4].location = 4;
            attribute_descriptions[4].format   = VK_FORMAT_R32G32B32_SFLOAT;
            attribute_descriptions[4].offset   = offsetof(VulkanMeshVertexColor, color);
