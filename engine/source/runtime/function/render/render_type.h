...
namespace Piccolo
{
    ...
    struct MeshVertexDataDefinition
    {
        ...
        float cx, cy, cz; // vertex color(smooth normal)
    };
    ...
    struct MaterialSourceDesc
    {
        ...
        bool operator==(const MaterialSourceDesc& rhs) const
        {
            return m_base_color_file == rhs.m_base_color_file &&
                   ...
                   m_light_map_texture_file == rhs.m_light_map_texture_file &&
                   m_ramp_warm_texture_file == rhs.m_ramp_warm_texture_file &&
                   m_ramp_cool_texture_file == rhs.m_ramp_cool_texture_file &&
                   m_face_map_texture_file == rhs.m_face_map_texture_file &&
                   m_nbr_material_setting_file == rhs.m_nbr_material_setting_file;
        }
        ...
        size_t getHashValue() const
        {
            ...
            hash_combine(hash,
                         ...
                         m_occlusion_file,
                         m_emissive_file,
                         m_light_map_texture_file,
                         m_ramp_warm_texture_file,
                         m_ramp_cool_texture_file,
                         m_face_map_texture_file,
                         m_nbr_material_setting_file);
            return hash;
        }
    };
    ...
    struct RenderMaterialData
    {
        ...
        std::shared_ptr<TextureData> m_light_map_texture;
        std::shared_ptr<TextureData> m_ramp_warm_texture;
        std::shared_ptr<TextureData> m_ramp_cool_texture;
        std::shared_ptr<TextureData> m_face_map_texture;
    };
} // namespace Piccolo
