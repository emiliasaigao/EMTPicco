...
namespace Piccolo
{
    ...
    public:
        ...
        VkImageView    m_depth_only_image_view {VK_NULL_HANDLE};
        VkImageView    m_stencil_only_image_view {VK_NULL_HANDLE};
        ...
        VkCommandBuffer      m_post_process_command_buffers[s_max_frames_in_flight];
        VkCommandBuffer      m_bloom_blur_compute_command_buffers[s_max_frames_in_flight];
        VkSemaphore          m_image_available_for_bloom_blur_semaphores[s_max_frames_in_flight];
        VkSemaphore          m_image_available_for_post_process_semaphores[s_max_frames_in_flight];
        ...
        VkCommandBuffer  m_current_post_process_command_buffer;
