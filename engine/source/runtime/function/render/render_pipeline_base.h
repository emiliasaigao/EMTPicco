...
namespace Piccolo
{
    ...
    protected:
        ...
        std::shared_ptr<RenderPassBase> m_post_process_pass;
        std::shared_ptr<RenderPassBase> m_ssao_generate_pass;
        ...
        std::shared_ptr<RenderPassBase> m_remap_pass;
        ...
        std::shared_ptr<RenderPassBase> m_blur_pass;
        std::shared_ptr<RenderPassBase> m_pre_depth_pass;
        std::shared_ptr<RenderPassBase> m_pcf_mask_gen_pass;
        std::shared_ptr<RenderPassBase> m_pcf_mask_blur_pass;
        std::shared_ptr<RenderPassBase> m_nbr_pass;
