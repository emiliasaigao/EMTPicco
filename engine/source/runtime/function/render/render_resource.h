...
namespace Piccolo
{
    ...
    {
        VkImage       _ssao_noise_texture_image {VK_NULL_HANDLE};
        VkImageView   _ssao_noise_texture_image_view {VK_NULL_HANDLE};
    ...
    struct GlobalRenderResource
    {
        ...
        SSAONoiseResource    _ssao_noise_resource;
    ...
    public:
        ...
        RenderGlobalEffectSettingObject m_render_global_effect_setting_object;
        ...
        std::map<size_t, VulkanNBRMaterial> m_vulkan_nbr_materials;
    ...
    private:
        ...
        void updateTextureImageDataNBR(std::shared_ptr<RHI> rhi, const TextureDataToUpdateNBR& texture_data);
    };
} // namespace Piccolo
