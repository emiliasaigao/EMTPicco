...
layout(push_constant) uniform PushConstants {
    highp mat4 proj_view_matrix; // 自动16字节对齐
} pushConstants;
...
layout(set = 0, binding = 1) readonly buffer _unused_name_per_drawcall_vertex_blending
{
...
void main()
{
    ...
    gl_Position = pushConstants.proj_view_matrix * vec4(position_world_space, 1.0f);
}
